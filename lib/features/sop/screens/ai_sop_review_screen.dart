...
class AISopReviewScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('AI SOP Review', style: AppTypography.title.copyWith(fontSize: 16)),
        centerTitle: true,
      ),
  ...
  Widget _buildDetailedScores(AISopReview review) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                _buildScoreRow('Grammar', review.grammar),
                _buildScoreRow('Clarity', review.clarity),
                _buildScoreRow('Structure', review.structure),
                _buildScoreRow('Storytelling', review.storytelling),
                _buildScoreRow('Goal Alignment', review.goalAlignment),
                _buildScoreRow('University Alignment', review.universityAlignment),
              ],
            ),
          ),
        ],
  ...
  Widget _buildRecommendationCard(AISopRecommendation rec) {
    return Container(
                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(rec.estimatedImprovement, style: AppTypography.caption.copyWith(color: AppColors.primary, fontWeight: FontWeight.bold, fontSize: 10)),
                    ),
                  ],
                ),
              ],
