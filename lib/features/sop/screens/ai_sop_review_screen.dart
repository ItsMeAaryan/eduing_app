...
class AISopReviewScreen extends ConsumerWidget {
      ...
      child: Center(
        child: Column(
          children: [
            ...
            Text('Overall SOP Quality Score', style: AppTypography.titleMedium.copyWith(color: Colors.white70)),
          ],
        ),
      ),
    ).animate().fade().scale();
  ...
  Widget _buildDetailedScores(BuildContext context, AISopReview review, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        SquircleCard(
          ...
          child: Column(
            children: [
              ...
              _buildScoreRow('Storytelling & Hook', review.storytelling, isDark),
              _buildScoreRow('Research & Alignment', review.researchDepth, isDark, isLast: true),
            ],
          ),
        ),
      ],
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Impact: ${rec.estimatedImprovement} • Priority: ${rec.priority}', style: AppTypography.caption.copyWith(color: AppColors.textSecondary)),
                        ],
                      ),
                    ),
                  ],
