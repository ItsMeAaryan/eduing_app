...
class ResumePdfService {
            ...
            children: [
              ...
              if (resume.education.isNotEmpty) ...[
                ...
                ...resume.education.map((edu) => pw.Bullet(
                    text: edu, style: const pw.TextStyle(fontSize: 10))),
                pw.SizedBox(height: 14),
              ],
              ...
              if (resume.experience.isNotEmpty) ...[
                ...
                pw.SizedBox(height: 4),
                ...resume.experience.map((exp) => pw.Bullet(
                    text: exp, style: const pw.TextStyle(fontSize: 10))),
                pw.SizedBox(height: 14),
              ],
              ...
              if (resume.projects.isNotEmpty) ...[
                ...
                pw.SizedBox(height: 4),
                ...resume.projects.map((proj) => pw.Bullet(
                    text: proj, style: const pw.TextStyle(fontSize: 10))),
              ],
            ],
          );
        },
  ...
  pw.Widget _buildSectionHeader(String title) {
    return pw.Column(
      ...
      children: [
        ...
        pw.Container(
            height: 1, color: PdfColors.blue800, width: double.infinity),
      ],
    );
  }
  ...
  Future<File> savePdfFile(UserResume resume) async {
    ...
    final file = File(
        "${outputDir.path}/${resume.fullName.replaceAll(' ', '_')}_Resume.pdf");
  ...
  Future<void> shareResumePdf(UserResume resume) async {
    ...
    await Share.shareXFiles([XFile(file.path)],
        text: 'Sharing Resume PDF for ${resume.fullName}');
  }
}
