...
class AppAnimation {
  ...
  static List<Effect> fadeAndSlideIn = [
    ...
    SlideEffect(begin: const Offset(0, 0.05), end: Offset.zero, duration: AppDuration.normal, curve: enter),
  ];

  static List<Effect> scaleIn = [
    FadeEffect(duration: AppDuration.normal, curve: enter),
    ScaleEffect(begin: const Offset(0.95, 0.95), end: const Offset(1, 1), duration: AppDuration.normal, curve: enter),
  ];
}
